...
class NoticiasI extends StatefulWidget {
  const NoticiasI({Key? key}) : super(key: key);

  @override
  State<NoticiasI> createState() => _NoticiasIState();
}

class _NoticiasIState extends State<NoticiasI> {
  @override
